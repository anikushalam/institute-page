...
const Department = () => {
  ...
  useEffect(() => {
    if (AllDepartment?.institute?.depart.length > 0) {
      // const department =
      setCurrentDepartment(
        AllDepartment.institute.depart.find((item: any) => did === item?._id)
      );
    }
  }, [AllDepartment, did]);
  ...
  return (
    <div>
      <div className="flex flex-col ">
        ...
        <HeadingWithImage>{currentDepartment?.dName}</HeadingWithImage>
          ...
          <div className="flex-1 p-6">
            {selectedContent === "about" ? (
              ...
              <VisionMission
                ...
                mission={
                  departmentSiteInfo?.department_site?.department_mission
                }
              />
              ...
              <ContactCard
                contacts={
                  departmentSiteInfo?.department_site?.department_contact
                }
              />
            ) : (
              <h1>Default</h1>
