...
const ViewNestedThree = ({ content, back }: { content: any; back: any }) => {
  ...
  return (
    <div>
      {
        //   nested ? (
        //     <ViewNestedThree content={currentContent} />
        //   ) :
        active && !nested ? (
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mx-2">
              {content?.nested_nested_nested_card?.map((item: any) => {
                if (item.is_nested) {
                  return (
...
export default ViewNestedThree;
