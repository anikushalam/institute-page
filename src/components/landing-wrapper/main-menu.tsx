...
const MainMenu = ({
  ...
  return (
    <div className="w-full bg-white shadow-sm">
      ...
      <div className="hidden w-full md:flex container mx-auto px-8 flex items-center justify-between">
        {instituteAbout?.landing_control?.tab_toggle?.home ? (
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
        ...
        {instituteAbout?.landing_control?.tab_toggle?.about ? (
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
        ...
        {instituteAbout?.landing_control?.tab_toggle?.academic_course ? (
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
        ...
        {instituteAbout?.landing_control?.tab_toggle?.department ? (
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
        ...
        {instituteAbout?.landing_control?.tab_toggle?.admission ? (
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
        ...
        {instituteAbout?.landing_control?.tab_toggle?.rnd ? (
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
        ...
        {instituteAbout?.landing_control?.tab_toggle?.examination ? (
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuLink
        ...
        {instituteAbout?.landing_control?.tab_toggle?.notice ? (
          <NavigationMenu>
            <NavigationMenuList>
              {" "}
              <NavigationMenuItem>
        ...
        {instituteAbout?.landing_control?.tab_toggle?.alumni ? (
          <NavigationMenu>
            <NavigationMenuList>
              {" "}
              <NavigationMenuItem>
        ...
        {instituteAbout?.landing_control?.tab_toggle?.library ? (
          <NavigationMenu>
            <NavigationMenuList>
              {" "}
              <NavigationMenuItem>
        ...
        {instituteAbout?.landing_control?.tab_toggle?.contact_us ? (
          <NavigationMenu>
            <NavigationMenuList>
              {" "}
              <NavigationMenuItem>
...
//       <div className="hidden md:flex container mx-auto px-8 py-1 flex items-center justify-around">
